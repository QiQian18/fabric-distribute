...
setGlobals () {
	...
	if [ $1 -eq 0 -o $1 -eq 1 -o $1 -eq 2 -o $1 -eq 3 ] ; then
		...
		if [ $1 -eq 0 ]; then
		    ...
		    CORE_PEER_ADDRESS=peer2.org1.lychee.com:7051
		else
		    CORE_PEER_ADDRESS=peer3.org1.lychee.com:7051
		fi
	else
		...
		if [ $1 -eq 4 ]; then
		    ...
		    CORE_PEER_ADDRESS=peer3.org2.lychee.com:7051
		fi
	fi
